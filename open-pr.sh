...
title=''
password=''
url='https://api.github.com/repos/eowino/advanced-bash-automation/pulls'
...
status_code=$(curl -s --user "$username:$password" -X POST "$url" -d "$data" -w %{http_code} -o /dev/null)
